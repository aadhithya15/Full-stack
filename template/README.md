...
| | present | gates |
|---|---|---|
| `base/` | **10 / 32** — M1…M10 | 10 PASS / 0 FAIL |
| tone folders | **10 each = 60 / 192** | 10 PASS / 0 FAIL, pose-lock **10/10** in all six |
| `universal-masking/` | **0 / 76** | mask builder + validator next task |
