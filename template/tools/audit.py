...
Per file:
  ...
  garment_L, delta garment mean luminance above the 128 field. 'fade' = delta too small: the recolour
                  mask cannot find an edge and the eye reads washed-out cloth. Floor raised from 26 to 45:
                  W15-kaftan measures 39.6 and is exactly the frame the user called faded, so 26 was a
                  gate that passed the defect being rebuilt away from.
...
LIM = dict(spread=2.0, off=1.5, cellstd=0.30, delta=45.0, grad=1.10, sil=(12.0, 46.0), sat=(18.0, 52.0))
